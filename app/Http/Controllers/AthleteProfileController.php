...
class AthleteProfileController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        $athleteData = [
            ...
            'highest_accomplishment' => $validated['highest_accomplishment'],
            'international_competition_name' => $validated['international_competition_name'],
            ...
            'training_frequency_days' => $validated['training_frequency_days'],
            'training_hours_per_day' => $validated['training_hours_per_day'],
            'scholarship_status' => $validated['scholarship_status'],
            'monthly_living_allowance' => $validated['monthly_living_allowance'],
            ...
            'average_tournament_allowance' => $validated['average_tournament_allowance'],
